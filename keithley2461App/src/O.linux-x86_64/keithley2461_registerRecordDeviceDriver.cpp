...
/* Generated from ../O.Common/keithley2461.dbd */
...
epicsShareExtern void (*pvar_func_keithley2461MotorRegister)(void);
...
int keithley2461_registerRecordDeviceDriver(DBBASE *pbase)
{
    const char *bldTop = "/home/alex/iocs/keithley2461";
    ...
    registerDevices(pbase, 101, deviceSupportNames, devsl);
    ...
    (*pvar_func_keithley2461MotorRegister)();
...
static const iocshFuncDef registerRecordDeviceDriverFuncDef =
                {"keithley2461_registerRecordDeviceDriver",1,registerRecordDeviceDriverArgs};
static void registerRecordDeviceDriverCallFunc(const iocshArgBuf *)
{
    keithley2461_registerRecordDeviceDriver(*iocshPpdbbase);
}
